...
const rewardedUnitId = 'ca-app-pub-6368412009992703/4189241578';
      ...
      <LinearGradient colors={["#538df8ff", "#5B3DB5", "#5B3DB5"]} start={{ x: 0, y: 0 }} end={{ x: 0, y: 1 }} style={{ flex: 1 }}>
        <View style={{ flex: 1, padding: 20, marginTop: 60}}>
          ...
          <Pressable
            ...
            style={{ position: 'absolute', right: 15, bottom: insets.bottom + 245, width: 44, height: 44, borderRadius: 14, backgroundColor: '#D7F3E3', alignItems: 'center', justifyContent: 'center', shadowColor: '#000', shadowOpacity: 0.12, shadowRadius: 8, shadowOffset: { width: 0, height: 4 } }}
          >
